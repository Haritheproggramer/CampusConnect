class SectionRosterData {
  ...
  // Add future section rosters here, keyed by class/section label.
  ...
  static List<Map<String, dynamic>> get allStudents => sectionRosters.values.expand((rows) => rows).toList(growable: false);

  static List<Map<String, dynamic>> studentsForSection(String className) =>
      List<Map<String, dynamic>>.from(sectionRosters[className] ?? const []);

  static List<Map<String, dynamic>> studentsForGroup(String className, String group) {
    return studentsForSection(className)
        .where((student) => student['group']?.toString() == group)
        .toList(growable: false);
  }

  static List<String> get availableSections =>
      allStudents
  ...
  static List<String> get availableGroups =>
      allStudents
          .map((student) => student['group']?.toString() ?? '')
